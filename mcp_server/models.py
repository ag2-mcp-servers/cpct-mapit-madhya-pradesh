...
class CertificateParameters(BaseModel):
    txt10thRollNo: str = Field(
        ..., description='10thRollNumber', examples=['eg 000000001']
    )
    txtCandidateAppSeq: str = Field(
        ..., description='Registration Number', examples=['0000001']
    )
    txtExamDate: str = Field(..., description='ExamDate', examples=['yyyy-mm-dd'])
...
class SkmstCertificatePostRequest(BaseModel):
...
class SkmstCertificatePostResponse(BaseModel):
...
class SkmstCertificatePostResponse1(BaseModel):
...
class SkmstCertificatePostResponse2(BaseModel):
...
class SkmstCertificatePostResponse3(BaseModel):
...
class SkmstCertificatePostResponse4(BaseModel):
...
class SkmstCertificatePostResponse5(BaseModel):
...
class SkmstCertificatePostResponse6(BaseModel):
